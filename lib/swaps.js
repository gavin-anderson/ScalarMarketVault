...
async function swap041(inputAmount, signer, provider, POOL_ADDRESS, SWAP_ROUTER_ADDRESS, LONG_TOKEN_ADDRESS, SHORT_TOKEN_ADDRESS) {
...
async function swap140(inputAmount, signer, provider, POOL_ADDRESS, SWAP_ROUTER_ADDRESS, LONG_TOKEN_ADDRESS, SHORT_TOKEN_ADDRESS) {
    // Initialize contracts with the local signer
    const poolContract = new ethers.Contract(POOL_ADDRESS, IUniswapV3PoolABI, provider);
    const swapRouterContract = new ethers.Contract(SWAP_ROUTER_ADDRESS, SwapRouterABI, provider);
    ...
    return {
        transaction: transaction,
        receipt: receipt,
        swappedDirection: _token0 == LONG_TOKEN_ADDRESS ? 'Short for Long' : 'Long for Short'

    };
}

async function quote041(inputAmount, signer, provider, POOL_ADDRESS, SWAP_ROUTER_ADDRESS, LONG_TOKEN_ADDRESS, SHORT_TOKEN_ADDRESS) {
...
async function quote140(inputAmount, signer, provider, POOL_ADDRESS, SWAP_ROUTER_ADDRESS, LONG_TOKEN_ADDRESS, SHORT_TOKEN_ADDRESS) {
